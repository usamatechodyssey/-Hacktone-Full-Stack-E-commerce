    ...
    <div className="flex flex-col p-6 bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto w-full border p-6 mb-10 shadow-lg bg-white rounded-lg">
        ...
        <div className="hidden md:block">
          {/* Table Headings */}
          <div className="grid grid-cols-3 md:grid-cols-5 gap-4 text-gray-500 text-sm  border-b pb-4 mb-4 font-clash">
          ...
          <div className="space-y-4">
            {/* Item 1 */}
            <div className="grid grid-cols-3 md:grid-cols-5 gap-4 items-center font-satoshi">
              <div className="flex col-span-2 items-center gap-4 w-[260px]">
                ...
                <div>
                  ...
                  <p className="text-left  font-satoshi">£125</p>
                </div>
              </div>
        ...
        <div className="block md:hidden space-y-6">
          ...
          <div className="flex flex-col gap-4 border-b pb-4">
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-500 font-satoshi">Quantity: 1</span>
              <p className="font-satoshi">£85</p>
            </div>
          </div>
        ...
        <div className="mt-6 text-right">
          ...
          <button className="mt-4 bg-[#2A254B] text-white py-2 xm:px-14 md:px-4 rounded hover:bg-[#1c1836] transition font-satoshi">
            Go to checkout
          </button>
        </div>
      </div>
